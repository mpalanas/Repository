...
suite=unittest.TestLoader().loadTestsFromTestCase(SavedProperties) # setup new test suite  - AlternateAgentProfile
#suite.addTests(unittest.TestLoader().loadTestsFromTestCase(AgentProfile1)) # add additional test cases
    #suite.addTests(unittest.TestLoader().loadTestsFromTestCase(BranchProfile)) co.nz site')
